    ...
    final class Pootle_Page_Builder
    {
        ...
        public function activation_redirect( $plugin )
        {
            if ( $plugin == plugin_basename( __FILE__ ) ) {
                die( wp_redirect( admin_url( 'admin.php?page=page_builder' ) ) );
            }
        }
        ...
        public function enqueue()
        {
            ...
            wp_register_script(
                'pootlepb-ui',
                POOTLEPB_URL . 'js/ppb-ui.js',
                array( 'jquery-ui-dialog', 'jquery-ui-tabs' ),
                POOTLEPB_VERSION
            );
            wp_register_style( 'pootlepb-ui-styles', POOTLEPB_URL . 'css/ppb-jq-ui.css', array() );
            wp_enqueue_style(
                'pootlepage-main-admin',
                plugin_dir_url( __FILE__ ) . 'css/main-admin.css',
                array(),
                POOTLEPB_VERSION
            );
            ...
            if ( $pagenow == 'admin.php' && false !== strpos( $page, 'page_builder' ) ) {
                ...
                wp_enqueue_style(
                    'ppb-option-admin',
                    POOTLEPB_URL . 'css/option-admin.css',
                    array(),
                    POOTLEPB_VERSION
                );
                ...
                if ( 'page_builder_modules' == $page ) {
                    wp_enqueue_style(
                        'ppb-option-modules',
                        POOTLEPB_URL . 'css/option-modules.css',
                        array(),
                        POOTLEPB_VERSION
                    );
                    wp_enqueue_script(
                        'ppb-option-modules',
                        POOTLEPB_URL . 'js/option-modules.js',
